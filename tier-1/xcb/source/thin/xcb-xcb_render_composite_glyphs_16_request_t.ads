...
package xcb.xcb_render_composite_glyphs_16_request_t is
   ...
   package C_Pointers is new Interfaces.C.Pointers
     (Index              => Interfaces.C.size_t,
      Element            => xcb.xcb_render_composite_glyphs_16_request_t.Item,
      Element_Array => xcb.xcb_render_composite_glyphs_16_request_t.Item_Array,
   ...
   package C_Pointer_Pointers is new Interfaces.C.Pointers
     (Index         => Interfaces.C.size_t,
      Element       => xcb.xcb_render_composite_glyphs_16_request_t.Pointer,
      Element_Array =>
        xcb.xcb_render_composite_glyphs_16_request_t.Pointer_Array,
      Default_Terminator => null);

   subtype Pointer_Pointer is C_Pointer_Pointers.Pointer;

end xcb.xcb_render_composite_glyphs_16_request_t;
