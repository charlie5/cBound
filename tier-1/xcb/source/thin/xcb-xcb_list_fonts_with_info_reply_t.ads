...
package xcb.xcb_list_fonts_with_info_reply_t is
   ...
   type Item_Array is
     array
       (Interfaces.C
          .size_t range <>) of aliased xcb.xcb_list_fonts_with_info_reply_t
       .Item;
   ...
   package C_Pointers is new Interfaces.C.Pointers
     (Index              => Interfaces.C.size_t,
      Element            => xcb.xcb_list_fonts_with_info_reply_t.Item,
      Element_Array      => xcb.xcb_list_fonts_with_info_reply_t.Item_Array,
   ...
   package C_Pointer_Pointers is new Interfaces.C.Pointers
     (Index              => Interfaces.C.size_t,
      Element            => xcb.xcb_list_fonts_with_info_reply_t.Pointer,
      Element_Array      => xcb.xcb_list_fonts_with_info_reply_t.Pointer_Array,
      Default_Terminator => null);

   subtype Pointer_Pointer is C_Pointer_Pointers.Pointer;

end xcb.xcb_list_fonts_with_info_reply_t;
